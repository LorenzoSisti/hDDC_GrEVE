...
#gmx grompp -f NPT_equilibration_step.mdp -c nvt.gro -t nvt.cpt -p topol.top -o npt.tpr -n index.ndx
...
####PROD1 with pin off 
gmx mdrun -deffnm npt -ntomp 8 -v -maxh 24 -ntmpi 4 -nb gpu -pme gpu -npme 1 -pin off -nstlist 500 -s npt.tpr
#gmx mdrun -deffnm prod1_pinon -ntomp 8 -v -maxh 24 -ntmpi 4 -nb gpu -pme gpu -npme 1 -pin on -nstlist 500 -s prod.tpr
