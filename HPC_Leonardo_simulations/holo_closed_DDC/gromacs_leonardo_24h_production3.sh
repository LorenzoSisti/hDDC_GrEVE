#!/bin/bash
#SBATCH --job-name prod3_holo_closed_DDC 
...
####PROD2 
gmx mdrun -deffnm prod3 -ntomp 8 -v -maxh 24 -ntmpi 4 -nb gpu -pme gpu -npme 1 -pin off -nstlist 500 -s prod_1000ns.tpr --cpi prod2.cpt -noappend 
