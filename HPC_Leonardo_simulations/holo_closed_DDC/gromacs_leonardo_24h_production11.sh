#!/bin/bash
#SBATCH --job-name prod4_dopa_plp 
...
####PROD2 
gmx mdrun -deffnm prod11 -ntomp 8 -v -maxh 24 -ntmpi 4 -nb gpu -pme gpu -npme 1 -pin off -nstlist 500 -s prod_1000ns.tpr --cpi prod10.cpt -noappend 
