...
#gmx grompp -f step6.1_equilibration.mdp -c em.gro -r em.gro -p topol.top -o nvt1.tpr -n index_new_new.ndx #farlo nella shell direttamente, non nello script 
